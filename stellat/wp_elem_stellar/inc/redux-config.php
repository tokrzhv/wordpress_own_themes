...
Redux::set_section(
	$opt_name,
	array(
		'title'            => esc_html__( 'Footer Info Fields', 'your-textdomain-here' ),
		'id'               => 'footer',
...
Redux::set_section(
    $opt_name,
    array(
        'title'            => esc_html__( 'About Info', 'your-textdomain-here' ),
        'id'               => 'footer-info',
        'subsection'       => true,
        ...
        'fields'           => array(
            array(
                'id'       => 'about-title',
                'type'     => 'text',
                'title'    => esc_html__( 'About title', 'your-textdomain-here' ),
                'default'  => '',
            ),
            array(
                'id'       => 'about-description',
                'type'     => 'textarea',
                'title'    => esc_html__( 'About description', 'your-textdomain-here' ),
                'default'  => '',
            ),
        ),
    ),
...
Redux::set_section(
    $opt_name,
    array(
        'title'            => esc_html__( 'About Contact', 'your-textdomain-here' ),
        'id'               => 'footer-contact',
        'subsection'       => true,
        'customizer_width' => '700px',
        'fields'           => array(
...
Redux::set_section(
    $opt_name,
    array(
        'title'      => esc_html__( 'Social Profiles Footer', 'your-textdomain-here' ),
